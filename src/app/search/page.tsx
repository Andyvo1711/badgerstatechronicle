...
export const metadata: Metadata = {
  title: "Search",
  description: "Search Badger State Chronicle for Wisconsin news, leadership, and community stories.",
};
...
export default async function SearchPage({
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      {!query && (
        <p className="mt-6 text-base text-muted">Enter a keyword to search Wisconsin stories.</p>
      )}
