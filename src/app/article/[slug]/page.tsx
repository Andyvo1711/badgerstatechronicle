  ...
  return (
    <article>
      ...
      <div className="mx-auto mt-6 max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="relative aspect-video w-full overflow-hidden bg-platinum">
          <Image
      ...
      <div
        className="prose prose-neutral mx-auto mt-8 max-w-3xl px-4 pb-6 leading-relaxed prose-headings:font-headline prose-headings:text-navy prose-a:text-lake sm:px-6 lg:px-8"
