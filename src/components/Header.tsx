...
export default function Header() {
  return (
    <header className="relative border-b border-platinum bg-navy">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        <Link href="/" className="shrink-0">
          ...
          <span className="block text-xs uppercase tracking-widest text-platinum">
            Wisconsin News, Leadership, Business, Health, and Community
          </span>
        </Link>
